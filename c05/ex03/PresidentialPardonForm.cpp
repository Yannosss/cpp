...
Form("default_name", PRES_MIN_GRADE_TO_SIGN, PRES_MIN_GRADE_TO_EXEC, "default_target")
{
...
Form(name, PRES_MIN_GRADE_TO_SIGN, PRES_MIN_GRADE_TO_EXEC, target)
{
	std::cout << "Constructor name/grade PresidentialPardonForm called"<< std::endl;
}

PresidentialPardonForm::PresidentialPardonForm(const PresidentialPardonForm& src): Form(src.get_name(), 
